...
A CLI tool to fetch trending GitHub repositories with a security score. As for v1.00, the CLI fetches weekly trending JavaScript repositories and the next version would allow more flexibility to fetch more types of repositories.
